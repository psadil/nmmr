...
When a voxel is tuned weakly, the scatterplot is nearly circular. When the data are circular, a line at any angle fits equally well. So, with circular scatterplots, orthogonal regression often produces slopes that have a spuriously high slope. 
